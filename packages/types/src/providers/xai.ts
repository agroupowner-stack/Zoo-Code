...
export const xaiModels = {
	...
	"grok-4.6": {
		...
		cacheReadsPrice: 0.5,
		description:
			"xAI's Grok 4.6 model with 500K context, configurable reasoning (low/medium/high/xhigh), and agentic tool calling via Responses API.",
	...
	"grok-build-0.1": {
		...
		cacheReadsPrice: 0.2,
		description: "xAI's Grok Build 0.1 coding model with 256K context window",
		includedTools: ["search_replace"],
		excludedTools: ["apply_diff"],
	},
	"grok-4.20": {
